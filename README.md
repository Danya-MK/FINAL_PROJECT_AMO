...
2. Запустите отдельные компоненты:
- Airflow: `airflow webserver` и `airflow scheduler`
- MLflow: `mlflow server`
- Flask: `python src/model_serving_api.py`

## Мониторинг

- Логи Airflow доступны в папке `logs/`
- Метрики моделей в MLflow UI
- API логи через Docker logs
